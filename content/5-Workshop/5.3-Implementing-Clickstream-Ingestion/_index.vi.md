...
![Sự kiện bucket S3 RAW](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/aws-s3-clickstream-ingest-events.png)

---

## 5.3.3 Thiết kế Lambda Ingest - `clickstream-lambda-ingest`

![Lambda Ingest](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/aws-lambda-clickstream-ingest-config.png)
...
![Route POST /clickstream](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/aws-apigw-clickstream-routes.png)
