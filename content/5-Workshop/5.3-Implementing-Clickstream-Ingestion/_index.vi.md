...
![Hình 5-5: API Gateway route cho POST /clickstream](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/5-3-apigw-clickstream-route.png)
...
![Hình 5-6: Lambda Ingest function overview](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/5-3-lambda-ingest-config.png)
...
![Hình 5-7: Raw clickstream JSON objects in the S3 bucket](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/5-3-s3-raw-objects.png)
...
![Hình 5-8: Ingestion flow from frontend to S3 Raw bucket](/images/5-Workshop/5.3-Implementing-Clickstream-Ingestion/5-3-ingestion-flow.png)
