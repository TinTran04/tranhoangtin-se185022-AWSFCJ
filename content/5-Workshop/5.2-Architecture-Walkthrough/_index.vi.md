...
![Hình 5-2: Các EC2 instance và các metric CloudWatch cơ bản](/images/5-Workshop/5.2-Architecture-Walkthrough/5-b-ec2-instances-metrics.png)
...
![Hình 5-3: Kiến trúc tổng thể nền tảng Clickstream Analytics cho hệ thống thương mại điện tử](/images/5-Workshop/5.2-Architecture-Walkthrough/5-1-clickstream-architecture.png)
...
![Hình 5-4: Sơ đồ mạng VPC cho OLTP và Analytics](/images/5-Workshop/5.2-Architecture-Walkthrough/5-2-vpc-network.png)