...
![Figure 5-9: Gateway VPC Endpoint attached to private route tables](/images/5-Workshop/5.4-Building-the-Private-Analytics-Layer/5-4-s3-gateway-vpce.png)
...
![Figure 5-10: VPC configuration of the ETL Lambda function](/images/5-Workshop/5.4-Building-the-Private-Analytics-Layer/5-4-lambda-etl-vpc.png)
...
![Figure 5-11: Private analytics layer with ETL Lambda, Data Warehouse, and S3 Gateway Endpoint](/images/5-Workshop/5.4-Building-the-Private-Analytics-Layer/5-4-etl-s3-endpoint.png)
